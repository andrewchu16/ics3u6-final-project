...
public class MenuScreen extends Screen {
    ...
    public MenuScreen(Window window) {
        ...
        continueButton.setHandler(window.new ButtonScreenSwapper(Const.GAME_SCREEN_NAME));
        newGameButton.setHandler(window.new ButtonScreenSwapper(Const.SELECT_SCREEN_NAME));
        settingsButton.setHandler(window.new ButtonScreenSwapper(Const.SETTINGS_SCREEN_NAME));
        howToPlayButton.setHandler(window.new ButtonScreenSwapper(Const.HOW_TO_PLAY_SCREEN_NAME));
